...
ALTER TABLE sandwiches.ingredient_allergen ADD CONSTRAINT fk_ingredient_allergen_ingredient FOREIGN KEY ( ingredient ) REFERENCES sandwiches.ingredient ( id );

ALTER TABLE sandwiches.ingredient_allergen ADD CONSTRAINT fk_ingredient_allergen_allergen FOREIGN KEY ( allergen ) REFERENCES sandwiches.allergen ( id );
